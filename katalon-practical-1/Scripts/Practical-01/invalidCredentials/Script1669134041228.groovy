...
'Set the password \r\n'
WebUI.setEncryptedText(findTestObject('Object Repository/LoginPage_OrangeHRM/input_Password_password'), 'SUjDCI/mE08=')
...
WebUI.verifyElementText(findTestObject('Object Repository/LoginPage_OrangeHRM/p_Invalid credentials'), 'Invalid credentials')
